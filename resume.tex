...
\begin{center}
	...
	\vspace{2mm}
	{\faEnvelope\ ndp190@gmail.com} | {\faMobile\ +84937321681} | {\faMapMarker\ Ho Chi Minh} \\
...
\begin{cventries}
	...
	{Oct 2024 – Present}
	{\begin{cvitems}
    \item {Maintain high-availability hosting environments.}
    \item {Support engineering teams in production deployments.}
    \item {Respond to incidents, resolve issues, and implement corrections.}
    \item {Build automation tools to handle engineering team inquiries.}
		\end{cvitems}}
	\cventry
